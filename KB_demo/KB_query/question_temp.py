...
1. 某演员演了什么电影   周润发演了什么电影
2. 某电影有哪些演员出演  ////   花样年华有哪些演员出演
3. 演员A和演员B合作出演了哪些电影   张曼玉和梁朝伟合作出演了哪些电影
4. 某演员参演的评分大于X的电影有哪些   周星驰参演的评分大于7的电影有哪些
5. 某演员出演过哪些类型的电影      周星驰出演过哪些类型的电影
6. 某演员出演的XX类型电影有哪些。  周星驰演了什么类型电影
7. 某演员出演了多少部电影。  周星驰演了多少部电影
8. 某演员演过喜剧电影吗。////// 周星驰演过喜剧电影吗
9. 某演员的生日/出生地/英文名/简介   周星驰的生日
10. 某电影的简介/上映日期/评分   卧虎藏龙的简介   卧虎藏龙的评分
...
class QuestionSet:
    ...
    def act_comedy_movie_question(word_objects):
        # 某演员演过喜剧电影吗？
...
rules = [
    ...
    Rule(condition_num=3, condition=person_entity + Star(Any(), greedy=False) + comedy + movie + Star(Any(), greedy=False), action=QuestionSet.act_comedy_movie_question),
